 ...
 * This is a non-Utility class, because it should be instantiated so that it can cache results.
 */
public class NucleusDistanceTool {
    ...
    private List<String> getAdjacentPositions(String position) {
        ...
        //It also uses border anomalies. What are border anomalies? If you're using them, I don't care what happens to you.
